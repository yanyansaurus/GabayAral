...
export default function NoteEditor({ note, onSave, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#1E293B]/60 backdrop-blur-sm">
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl flex flex-col overflow-hidden" style={{ maxHeight: "90vh" }}>
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-200 rounded-2xl px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-[#6C63FF]/30 focus:border-[#6C63FF] transition-all placeholder-gray-300"
            />
          </div>
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl text-xs font-medium border transition-all ${
                    subject === s
                      ...
                      : "bg-white text-gray-600 border-gray-200 hover:border-[#6C63FF]/50 hover:text-[#6C63FF]"
                  }`}
                >
                  {s}
                </button>
          ...
          <div className="flex-1">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-xs text-gray-400">{wordCount} salita · {content.length} chars</span>
            </div>
            <textarea
              value={content}
              ...
              rows={12}
              className="w-full border border-gray-200 rounded-2xl px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-[#6C63FF]/30 focus:border-[#6C63FF] transition-all resize-none font-mono leading-relaxed placeholder-gray-300"
            />
